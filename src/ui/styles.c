...
void init_style_label_default_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_text_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][10]));
    lv_style_set_text_font(style, &lv_font_montserrat_14);
};
...
void init_style_label_secondary_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_text_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][11]));
};
...
void init_style_label_nav_text_alternate_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_text_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][6]));
...
void init_style_style_default_slider_INDICATOR_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][6]));
};
...
void init_style_style_default_slider_KNOB_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][5]));
};
...
void init_style_arc_default_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_arc_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][3]));
...
void init_style_arc_default_INDICATOR_DEFAULT(lv_style_t *style) {
    lv_style_set_arc_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][6]));
    lv_style_set_arc_width(style, 20);
};
...
void init_style_checkbox_default_INDICATOR_DEFAULT(lv_style_t *style) {
    lv_style_set_border_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][3]));
};
...
void init_style_spinner_default_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_bg_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][6]));
    lv_style_set_arc_color(style, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][4]));
};
